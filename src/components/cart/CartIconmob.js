...
const CartIcon = () => {
	...
	return (
		<Link href="/cart">
			<a className="block lg:hidden  mr-4 text-black hover:text-black relative">
				...
				{ productsCount ? <span className="flex justify-center items-center  ml-1 bg-red-500 w-5 h-5 rounded-full absolute top-0 right-0">{ productsCount }</span> : '' }
