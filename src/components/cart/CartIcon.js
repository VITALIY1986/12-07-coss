...
const CartIcon = () => {
	...
	return (
		<Link href="/cart">
			<a className="block mt-4 lg:inline-block lg:mt-0 text-black hover:text-black mr-10 relative">
				...
				{ productsCount ? <span className="flex justify-center items-center text-white  ml-1 bg-red-500 w-5 h-5 rounded-full absolute top-0 right-0">{ productsCount }</span> : '' }
