...
{product && product.attributes && product.attributes.nodes && product.attributes.nodes.length > 0 ? (
 ...
 // initially until getStaticProps() finishes running
	...
	return (
     ...
     <link rel="canonical" href={product?.slug} ></link>
     <meta property="og:image" content={ product?.image?.sourceUrl }></meta>
     <meta property="og:title" content={product.seo.title}></meta>
<meta property="og:description" content={product.seo.metaDesc}></meta>
	</Head>
        { product ? (
...
className="singl_product_description mb-5 mt-3 "
                        ...
                        <div className='mt-3'>
                       <span className='font-bold'>SKU:</span> <span className='text-gray-400   '>{product.sku}</span>
